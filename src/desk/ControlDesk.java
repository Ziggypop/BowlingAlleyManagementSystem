package desk;/* desk.ControlDesk.java
 *
 *  Version:
 *  		$Id$
 * 
 *  Revisions:
 * 		$Log: desk.ControlDesk.java,v $
 * 		Revision 1.13  2003/02/02 23:26:32  ???
 * 		desk.ControlDesk now runs its own thread and polls for free lanes to assign queue members to
 * 		
 * 		Revision 1.12  2003/02/02 20:46:13  ???
 * 		Added " 's Simulation.Party" to party names.
 * 		
 ...
 * 		Added desk.ControlDeskEvent and desk.ControlDeskObserver. Updated desk.Queue to allow access to Vector so that contents could be viewed without destroying. Implemented observer model for most of desk.ControlDesk.
 * 		
...
public class ControlDesk extends Thread {
    ...
    /**
     * Constructor for the desk.ControlDesk class
     *
	...
	/**
	 * Main loop for desk.ControlDesk's thread
	 * 
	 */
	public void run() {
		while (true) {
    ...
    /**
     * Retrieves a matching Simulation.Bowler from the bowler database.
     *
     * @param nickName	The NickName of the Simulation.Bowler
     *
     * @return a Simulation.Bowler object.
     *
     */
    ...
    /**
     * Accessor for the number of lanes represented by the desk.ControlDesk
     * 
     ...
     * 
     * @param adding	the desk.ControlDeskObserver that will be subscribed
     *
     */
     ...
     * 
     * @param event	the desk.ControlDeskEvent to broadcast
     *
     */
